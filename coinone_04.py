...
def main():
    ...
    # BUY ORDER
    if (exe == 'Y') or (exe =='y'):
        result=coin_limit_buy(price,qty,currency) #price, qty, currency 
        res = json.loads(result)
        # print(res) 
        # #{'result': 'success', 'errorCode': '0', 'orderId': '6d8a5fb3-1e4e-11e9-9ec7-00e04c3600d7'}
        if str(res['errorCode']) == '0':
            print('ordered - \nResult: %s \nErrorCode: %s \norderId: %s' %(res['result'],res['errorCode'], res['orderId']))
            print('price : %s' %price)
            print('qty : %s' %qty)
            print('currency: %s' %currency)
...
# price: 74950.0
# qty: 1
# would you like to BUY order this? (y/N)y
# {'result': 'success', 'errorCode': '0', 'orderId': '6d8a883b-1e4e-11e9-9ec7-00e04c3600d7'}
# ordered -
# Result: success
# ErrorCode: 0
# orderId: 6d8a883b-1e4e-11e9-9ec7-00e04c3600d7
# price : 74950.0
# qty : 1
# currency: BTG
# ORDER SUBMITTED.
        else:
            print('order error code: %s' %res['errorCode'])
...
# order No. 0
# {'index': '0', 'orderId': '6d8b98f0-1e4e-11e9-9ec7-00e04c3600d7', 'timestamp': '1635143476', 'price': '75100.0', 'qty': 
# '1.0', 'type': 'bid', 'feeRate': '0.001'}
# 6d8b98f0-1e4e-11e9-9ec7-00e04c3600d7
# order No. 1
# {'index': '1', 'orderId': '6d8b7cf6-1e4e-11e9-9ec7-00e04c3600d7', 'timestamp': '1635143435', 'price': '74950.0', 'qty': 
# '1.0', 'type': 'bid', 'feeRate': '0.001'}
# 6d8b7cf6-1e4e-11e9-9ec7-00e04c3600d7
# order No. 2
# {'index': '2', 'orderId': '6d8b712a-1e4e-11e9-9ec7-00e04c3600d7', 'timestamp': '1635143419', 'price': '74950.0', 'qty': 
# '1.0', 'type': 'bid', 'feeRate': '0.001'}
# 6d8b712a-1e4e-11e9-9ec7-00e04c3600d7

# ORDER_BOOK
# ['orderId', 'timestamp', 'DT','price', 'qty'(real), 'type', 'feeRate', 'status'(filled/live/partially_filled) 
# LIVE_ORDER
# result errorcode status orderId currency type price qty remainQty timestamp
# {'result': 'success', 'errorCode': '0', 'limitOrders': [{'index': '0', 'orderId': '6d8a883b-1e4e-11e9-9ec7-00e04c3600d7', 'timestamp': '1635143044', 'price': '74950.0', 'qty': '1.0', 'type': 'bid', 'feeRate': '0.001'}]}
    
    
    #order id 조회
    # order_id=orders['limitOrders'][0]['orderId']
    order_id='6d8b98f0-1e4e-11e9-9ec7-00e04c3600d7'
    status=c.get_my_order_status(currency='btg',order_id=order_id)
    print(status)

#     {'result': 'success', 'errorCode': '0', 'status': 'live', 'info': {'orderId': '6d8a883b-1e4e-11e9-9ec7-00e04c3600d7', 'currency': 'BTG', 'type': 'bid', 'price': '74950.0', 'qty': '1.0', 'remainQty': '1.0', 'feeRate': '0.001', 'fee': '0.0', 
# 'timestamp': '1635143044'}}
# "live" "filled" "partially_filled"
